...
def generate_html(gt_path, results_path, methods, models_per_page=50):
    ...
    with open('inpatint_depth_eval_valid_masked.html', 'w') as f:
        f.write(html_content)

    print(f"HTML file 'inpatint_depth_eval_valid_masked.html' has been generated with {total_pages} pages.")
